...
export function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md px-3 py-2 text-xs shadow-xl transition-all",
        className
      )}
    >
...
export function ChartLegendContent({
  ...
  return (
    <div
      className={cn(
        "flex items-center justify-center gap-4 text-xs font-medium text-zinc-600 dark:text-zinc-400",
