  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen">
        {/* Hero Section */}
        <section className="relative z-30 h-auto md:h-[60vh] min-h-[460px] md:min-h-[550px] flex items-center">
          {/* Background car image & dark overlays in a dedicated overflow-hidden container */}
        ...
        {featuredVehicles && featuredVehicles.length > 0 && (
          <section className="relative z-20 py-8 md:py-16 border-b border-zinc-200 dark:border-zinc-800">
        ...
        {localVehicles && localVehicles.length > 0 && (
          <section className="relative z-10 py-8 md:py-16 bg-zinc-50 dark:bg-zinc-950/50">
            <div className="container mx-auto px-4">
              <div className="flex justify-between items-end mb-5 md:mb-8">
                <div>
